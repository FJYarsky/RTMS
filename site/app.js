...
const TRANSLATIONS = {
    es: {
        ...
        brand_sec_tag: "Identidad de Marca",
        brand_sec_title: "Sistema de Diseño & Vector Assets",
        brand_sec_desc: "Arquitectura visual optimizada para Windows en modo oscuro nativo: obturador mecánico de 6 aspas, gradiente cian-teal y tipografía blanca de alto contraste.",
        brand_card_imagotype_desc: "Composición apaisada oficial para barras de navegación, encabezados de software y transmisiones en vivo.",
        brand_card_isotype_desc: "Diafragma iris de 6 aspas con simetría rotacional de 60° y apertura hexagonal central en gradiente Sky Cyan y Neon Teal.",
        brand_card_vertical_desc: "Formato apilado y centrado para pantallas de inicio, modales de información y tarjetas de presentación.",
        brand_card_ico_desc: "Binario .ico oficial con 6 capas RGBA (256 a 16 px) para barra de tareas, bandeja de sistema y ejecutables.",
        brand_btn_guide: "Guía BRANDING.md →",
        brand_sheet_tag: "Especificación Técnica",
        brand_sheet_title: "Hoja Maestra de Identidad y Tokens de Color",
        brand_sheet_desc: "Consulta la guía exhaustiva en <code>docs/BRANDING.md</code> con la matemática vectorial, tokens CSS, tipografías del sistema y pautas de empaquetado con PyInstaller.",
        brand_btn_view_guide: "Leer Especificación Completa",
        brand_btn_view_sheet: "Ver Hoja Gráfica de Muestra",
        ...
        footer_brand_assets: "Logos & Assets de Marca",
        ...
        footer_branding_doc: "Guía de Identidad (BRANDING.md)",
    ...
    en: {
        ...
        brand_sec_tag: "Brand Identity",
        brand_sec_title: "Design System & Vector Assets",
        brand_sec_desc: "Visual architecture built for Windows in native dark mode: 6-blade mechanical iris, cyan-to-teal gradient, and high-contrast white typography.",
        brand_card_imagotype_desc: "Official horizontal composition for navigation bars, software headers, and live broadcast overlays.",
        brand_card_isotype_desc: "6-blade iris aperture with 60° rotational symmetry and central hexagonal opening in Sky Cyan and Neon Teal gradient.",
        brand_card_vertical_desc: "Stacked centered layout for splash screens, information modals, and presentation cards.",
        brand_card_ico_desc: "Official .ico binary with 6 RGBA layers (256 to 16 px) for taskbar, system tray, and executables.",
        brand_btn_guide: "BRANDING.md Guide →",
        brand_sheet_tag: "Technical Specification",
        brand_sheet_title: "Master Identity Sheet & Color Tokens",
        brand_sheet_desc: "Check the comprehensive guide in <code>docs/BRANDING.md</code> covering vector geometry, CSS tokens, system fonts, and PyInstaller bundling.",
        brand_btn_view_guide: "Read Full Specification",
        brand_btn_view_sheet: "View Graphic Asset Sheet",
        ...
        footer_brand_assets: "Brand Logos & Assets",
        ...
        footer_branding_doc: "Identity Guide (BRANDING.md)",
