# Guía de Resolución de Problemas (Troubleshooting) — RTMS v2.2.1
...
1. **Cámara Virtual NVIDIA Broadcast en Autoarranque**:
   ...
   - **Solución en RTMS v2.2.1**: RTMS detecta automáticamente `NVIDIA Broadcast` como dispositivo virtual y establece `auto_start: false`. Inicia esta cámara únicamente cuando sea estrictamente necesario. Además, la telemetría en el HUD te permite supervisar el uso de GPU y VRAM en tiempo real.
2. **P-States de NVENC**:
...
<!-- RTMS Troubleshooting Guide v2.2.1 -->
