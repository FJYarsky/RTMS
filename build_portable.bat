@echo off
REM RTMS v2.2.1 Automated Portable Packager
REM ==============================================================================
REM RTMS v2.2.1 — Build Script para ejecutable nativo portable (pywebview)
...
echo.
echo ============================================================
echo  RTMS v2.2.1 — Creando aplicacion nativa con PyInstaller
echo ============================================================
echo.
