...
* El uso de lenguaje o imágenes sexualizadas, y la aproximación o atención sexual no deseada.
* Comentarios insultantes o despectivos (*trolling*), y ataques personales o políticos.
* El acoso público o privado.
* La publicación de información privada de otros, como direcciones físicas o electrónicas, sin su consentimiento explícito.
...
Este Código de Conducta se aplica a todos los espacios de la comunidad y también se aplica cuando un individuo representa oficialmente a la comunidad en espacios públicos. Ejemplos de representación de nuestra comunidad incluyen el uso de una dirección de correo electrónico oficial, publicaciones a través de cuentas oficiales de redes sociales, o actuar como representante designado en eventos presenciales o virtuales.

## Aplicación y Contacto

Casos de comportamiento abusivo, acosador o inaceptable pueden ser reportados a los líderes de la comunidad responsables de la aplicación en:
**Joaquín Yarsky** — [joaquinyarsky@gmail.com](mailto:joaquinyarsky@gmail.com).

Todas las quejas serán revisadas e investigadas de manera justa y rápida. Todos los líderes de la comunidad están obligados a respetar la privacidad y seguridad de quien reporta cualquier incidente.
