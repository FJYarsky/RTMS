...
from core.config_mgr import export_config, load_config, save_config
...
def test_config_isolated_from_production():
    ...
    real_prod_config = os.path.abspath(
...
def test_export_config_safe_mode():
    cfg = {
        "version": "2.2.2",
        "cameras": {"cam1": {"friendly_name": "Camera 1", "srt_passphrase": "SuperSecretPassphrase123!", "port": 9000}},
    }
    save_config(cfg)
